...
public class HIUA {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.get("https://vm-s4b-blddpy31/Pure.Portal/secure/agent/findclient.aspx");

		driver.manage().window().maximize();
		driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);
		Actions action = new Actions(driver);
		driver.findElement(By.id("username")).sendKeys("subagent2@blueinsurance.com");
		...
		driver.findElement(By.id("ctl00_cntMainBody_txtClientCode")).sendKeys("RAOP");
